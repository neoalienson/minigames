...
class ChineseChessBoardPage extends StatefulWidget {
  const ChineseChessBoardPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ChineseChessBoardPageState createState() => _ChineseChessBoardPageState();
}

class _ChineseChessBoardPageState extends State<ChineseChessBoardPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chinese Chess Board'),
      ),
      body: Center(
        child: Column(
